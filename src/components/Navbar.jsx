      ...
      <div className='flex w-5/6 py-6 mx-auto items-center'>
        ...
        <nav className='ml-auto'>
          <ul className='flex space-x-6'>
            <Link className='button'>Beranda</Link>
            <Link className='button'>Kelas</Link>
            <Link className='button'>Konverter</Link>
          </ul>
        </nav>
        ...
        <button
          ...
          onClick={changeTheme}>
          {isLightTheme ? (
            <MoonIcon className='w-6 h-6 fill-coffee-900 group-hover:fill-coffee-300 hover-transition ' />
          ) : (
            <SunIcon className='w-6 h-6 fill-coffee-900 group-hover:fill-coffee-300 hover-transition ' />
          )}
          <span
